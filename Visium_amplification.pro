...
<Velocity11 file='Protocol_Data' md5sum='0f6d4ed562f787f6d8d150cf9491bc9e' version='2.0' >
...
var indexColumn = global.settings.indexColumn || 2;
...
var indexVolume = global.settings.indexVolume || 0;
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						...
						<Parameter Category='Static labware configuration' Name='3' Value='96 Deep Well PP Sqr Well V Btm' />
						<Parameter Category='Static labware configuration' Name='4' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='5' Value='96 Nunc Deep Well 1 mL' />
...
task.Body = &quot;When the robots has finished, &quot; +
	...
	&quot;and choose &apos;Continue&apos;.&quot;;' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='RTreagentPlate - 1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = indexVolume;
task.Wellselection = [[1,indexColumn]];
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(indexVolume, 0.5);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (reagentVolume + indexVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.7 * (sampleVolume + reagentVolume + indexVolume);
