...
<Velocity11 file='Protocol_Data' md5sum='14d08b6293329f2b7478c4f185710b0c' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet_red4-6.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var tipColumn = global.settings.tipColumn || [[1, 13 - columns]];
var tipOffColumn = global.settings.tipOffColumn || [[1,1]];
var beadColumn = global.settings.beadColumn || [[1, 1]];
var etohColumn = global.settings.etohColumn || [[1, 1 + columns]];
var etohAspHeight = global.settings.etohAspHeight || 1;
var ebColumn = global.settings.ebColumn || [[1, 1 + (2 * columns)]];
var bindColumn = global.settings.bindColumn || [[1,1]];
var bind2Column = global.settings.bind2Column || [[1,2]];
var sampleColumn = global.settings.sampleColumn || [[1,1]];
var wasteColumn = global.settings.wasteColumn||  [[1,1]];
var finalColumn = global.settings.finalColumn||  [[1,1]];
var beadVolume1 = global.settings.beadVolume1 || 95;
var beadVolume2 = global.settings.beadVolume2 || 30;
var bindVolume = global.settings.bindVolume || 160;
var totBeadVolume1 = global.settings.totBeadVolume1 || 100;
var totBeadVolume2 = global.settings.totBeadVolume2 || 100;
var sampleVolume = global.settings.sampleVolume || 100;
var transferVolume = global.settings.transferVolume || 180;
var elutionVolume = global.settings.elutionVolume || 25;
var keepPlate = global.settings.keepPlate;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if(keepPlate) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='Replace the Eppendorf PCR plate on position 4 with a new Eppendorf PCR plate and press continue. The protocol will proceed to elute the final libraries into column 1-2 of the new plate.' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='RTreagentPlate' />
...
task.Wellselection = [[1,bind2Column]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,bind2Column]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;

if(keepPlate) {
task.Wellselection = [[1,finalColumn]];
} else {
...
&lt;/Velocity11&gt;' />
   ...
   task.Wellselection = [[1,tipOffColumn]];
} else {
   task.skip();
}' />
					<Parameters >
...
task.Volume = mPreAspVolume;
task.Wellselection = [[1,bindColumn]];
task.Distancefromwellbottom = 50;
task.Liquidclass = &quot;j_normal_large_vol&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BindPlate' />
...
var mIncubationTime = bindTime;
var mTimerCycles = 3;
var mMixVolume = (beadVolume2 + bindVolume) * 0.8;
var mAspDistance = 1.25;
var mDispDistance = 1.25;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='210' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='// Calculate how many mix cycles that corresponds 
// to total incubation time: 
mTimer = (new Date().getTime() - mTimer) / 1000;
...
task.Wellselection = [[1,ebColumn]];
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTreagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,ebColumn]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='removeBindMix' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='
var mHeadMode = headMode;
// var mBind2WellSelection = bind2Well;
// var mWasteWellSelection = wasteWell;
// var mTipSelection = tipSelection;
var mGetTips = true;
var mReturnTips = true;
var mLiquidClass = &quot;j_slow_medium_vol&quot;;
var mPreAspVolume = PRE_ASP_LARGE;
var mTransferVolume = bindVolume + beadVolume2 + 10;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,wasteColumn]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;
task.Performtiptouch = true;
...
task.Wellselection = [[1,wasteColumn]];
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_blowout&quot;;
task.Distancefromwellbottom = mBlowoutHeight;
task.Performtiptouch = mDoTipTouch;
...
var mTransferVolume = RINSE_VOLUME;
var mAspDistance = 1;
var mDispDistance = 30;
var mDoTipTouch = true;
var mTouchRetract = 0;' />
...
task.Preaspiratevolume = PRE_ASP;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTreagentPlate' />
...
var mAspDistance = 0.5;
var mDispDistance = 1;
var mMixVolume = (0.8 * totBeadVolume1 &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * totBeadVolume1;
...
task.Wellselection = [[1,beadColumn]];
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;' />
					<Parameters >
...
if((mMixAspDistance != mMixDispDistance) &amp; (mMixVolume &gt; 80)) {
   task.Dispenseatdifferentdistance = true;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,beadColumn]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,bindColumn]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
...
var mAspDistance = 0.5;
var mDispDistance = 1;
var mMixVolume = (0.8 * totBeadVolume2 &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * totBeadVolume2;
var mMixLiquidClass = &quot;j_normal_mixing&quot;;
var mMixCycles = 5;
var mMixAspDistance = 0.5;
var mMixDispDistance = 5;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBindMix' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = headMode;
// var mWellSelection = sampleWell;
// var mBindWellSelection = bindWell;
// var mBind2WellSelection = bind2Well;
// var mTipSelection = tipSelection;
var mGetTips = true;
var mReturnTips = true;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mNumberSteps = Math.ceil(bindVolume / MAX_VOLUME);' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='7' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,bindColumn]];
task.Volume = bindVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BindPlate' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferSample' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mPreAspVolume = 15;
var mBlowoutHeight = 20;
var mDoTipTouch = true;
var mTouchRetract = -19;
var mGetTips = false;
...
var bindMixVolume = 0.6 * (beadVolume1 + sampleVolume);
bindMixVolume = (bindMixVolume &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : bindMixVolume;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
...
task.Wellselection = [[1,sampleColumn]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
task.Wellselection = [[1,etohColumn]];
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;' />
					<Parameters >
...
task.Wellselection = [[1,etohColumn]];
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = etohAspHeight;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTreagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
