...
<Velocity11 file='Protocol_Data' md5sum='1eab7bc1a8e292ad3d41268c2e7b28ea' version='2.0' >
...
var totBeadVolume = global.settings.totBeadVolume || 100;
...
var mTimerCycles = 3;
var mMixVolume = (beadVolume + sampleVolume) * 0.8;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = headMode;
// var mWellSelection = ebWell;
// var mBindWellSelection = bindWell;
// var mFinalWellSelection = finalWell;
// var mTipSelection = tipSelection;
// var mTipOffSelection = tipOffSelection;
var mGetTips = true;
var mReturnTips = true;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,finalColumn]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBeads' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mGetTips = true;
...
var mAspDistance = 1;
var mDispDistance = 1;
var mMixVolume = (0.8 * totBeadVolume &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * totBeadVolume;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mNumberSteps = Math.ceil(beadVolume / MAX_VOLUME);' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='8' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
task.Volume = (beadVolume / mNumberSteps);
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTreagentPlate' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferSample' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mLiquidClass = &quot;j_slow_medium_vol&quot;;
...
var bindMixVolume = 0.8 * (beadVolume + sampleVolume);
