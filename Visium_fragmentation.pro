...
<Velocity11 file='Protocol_Data' md5sum='76a9a3b696fd32adf1d56fa40b9bde0d' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='1' AutomaticallyLoadFormFile='0' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet_red4-6.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var headMode = &quot;1,1,1,&quot; + columns;
var tipColumn = global.settings.tipColumn || 1;
var tipOffColumn = global.settings.tipOffColumn || 1;
var sampleColumn = global.settings.sampleColumn || 1;
var reagentColumn = global.settings.reagentColumn || 2;
var ebColumn = global.settings.ebColumn || 2;
var oilColumn = global.settings.oilColumn || 4;
...
var ebVolume = global.settings.ebVolume || 0;
var oilVolume = global.settings.oilVolume || 0;
var incubation1Temperature = global.settings.incubation1Temperature || 20;
var incubation2Temperature = global.settings.incubation2Temperature || 20;
var doOffDeckIncubation = global.settings.doOffDeckIncubation;
var incubation1Time = global.settings.incubation1Time * timeMod;
var incubation2Time = global.settings.incubation2Time * timeMod;
...
global.statusString = protocolName + &quot; started&quot;;' />
	...
	task.Temperature = incubation2Temperature;
}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=tempRT' Value='incubation2Temp' />
	...
	task.Temperature = incubation1Temperature;
}' />
					<Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='TransferToReactionPlate' />
						...
						<Parameter Category='Static labware configuration' Name='3' Value='96 Nunc Deep Well 1 mL' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='TransferToReactionPlate' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
...
task.Incubationtime = incubation1Time;' />
					<Parameters >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Reset temp pos6' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='96 Nunc Deep Well 1 mL' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Reset temp pos6' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='SetTemperature2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='96 Nunc Deep Well 1 mL' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='SetTemperature2' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Incubate' >
					<Devices >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(doOffDeckIncubation) task.skip();
task.Incubationtime = incubation2Time;' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='4095' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(!doOffDeckIncubation) task.skip();
...
task.Body = &quot;When the robots has finished, &quot; +
	...
	&quot;and choose &apos;Continue&apos;.&quot;;' />
			...
			<Pipette_Process Name='Reset temp pos6' >
				<Minimized >0</Minimized>
...
task.skip();' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = 4;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
...
task.Temperature = incubation1Temperature;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=incubation1Temperature;' Value='' />
						<Parameter Category='' Name='Wait' Value='1' />
						<Parameter Category='' Name='Temperature Tolerance' Value='1' />
						<Parameter Category='' Name='Timeout' Value='10' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
			...
			<Pipette_Process Name='SetTemperature2' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Reserve Location' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
task.Temperature = incubation2Temperature;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=incubation2Temperature' Value='' />
						<Parameter Category='' Name='Wait' Value='1' />
						<Parameter Category='' Name='Temperature Tolerance' Value='1' />
			...
			<Pipette_Process Name='TransferReagent' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mReturnTips = false;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = ebVolume;
task.Wellselection = [[1, ebColumn]];
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(ebVolume, 0.5);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(reagentVolume, 0.5);' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (ebVolume + reagentVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.7 * (ebVolume + sampleVolume + reagentVolume);
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='TransferToReactionPlate' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mGetTips = false;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='var transferVolume = (ebVolume + sampleVolume + reagentVolume);
task.Volume = transferVolume;
task.Wellselection = [[1,sampleColumn]];
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(transferVolume, 0.5);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (ebVolume + sampleVolume + reagentVolume);
task.Wellselection = [[1,sampleColumn]]; ' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = PRE_ASP_SMALL;
task.Wellselection = [[1,oilColumn]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = oilVolume;
task.Wellselection = [[1,oilColumn]];
task.Distancefromwellbottom = 0.4;
task.Dynamictipextension = global.dph(oilVolume, 0.4);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='RTReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1, tipOffColumn]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='UsedTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
